...
export default function HorizontalcardComp() {
  ...
  <div class="card-media">
    ...
    <div class="card-media-object-container">
      <div className="card-media-object" style={{ backgroundImage: "url(https://cdn0.weddingwire.in/vendor/3007/3_2/960/jpg/rock-music-event_15_163007-163972929437664.jpeg)"}}></div>
      <span class="card-media-object-tag subtle">Selling Fast</span>
      <ul class="card-media-object-social-list">
        <li>
          <img src="https://s10.postimg.cc/3rjjbzcvd/profile_f.jpg" class="" alt=''/>
        </li>
        <li>
          <img src="https://s16.postimg.cc/b0j0djh79/profile_0_f.jpg" class="" alt=''/>
        </li>
  ...
  <div class="card-media">
   {/*  <!-- media container --> */}
    <div class="card-media-object-container">
    <div className="card-media-object" style={{ backgroundImage: "url(https://img.freepik.com/free-vector/modern-music-event-poster-template_1361-1292.jpg)" }}></div>
      <ul class="card-media-object-social-list">
        <li>
          <img src="https://s13.postimg.cc/c5aoiq1w7/stock3_f.jpg" class="" alt='scsc'/>
        </li>
      </ul>
    </div>
    {/* <!-- body container --> */}
  ...
  <div class="card-media">
   {/*  <!-- media container --> */}
    <div class="card-media-object-container">
    <div className="card-media-object" style={{ backgroundImage: "url(https://static.sliit.lk/wp-content/uploads/2018/01/Wiramaya-2017.jpg)" }}></div>
      <ul class="card-media-object-social-list">
        <li>
          <img src="https://s13.postimg.cc/c5aoiq1w7/stock3_f.jpg" class="" alt='scsc'/>
        </li>
  ...
  <div class="card-media">
   {/*  <!-- media container --> */}
    <div class="card-media-object-container">
    <div className="card-media-object" style={{ backgroundImage: "url(https://static01.nyt.com/images/2023/04/22/multimedia/19AI-SONGS-02-cjlw/19AI-SONGS-02-cjlw-videoSixteenByNineJumbo1600.jpg)" }}></div>
      <ul class="card-media-object-social-list">
        <li>
          <img src="https://s13.postimg.cc/c5aoiq1w7/stock3_f.jpg" class="" alt='scsc'/>
        </li>
