    ...
    <Box sx={{ width: '100%' }}>
      <Box sx={{ borderBottom: 1, borderColor: 'divider', }}>
        <Tabs value={value} onChange={handleChange} aria-label="basic tabs example">
          <Tab label="Gold Package" style={{color:'black'}} {...a11yProps(0)} />
          <Tab label="Silver Package"style={{color:'black'}} {...a11yProps(1)} />
          <Tab label="Bronze Package"style={{color:'black'}} {...a11yProps(2)} />
        </Tabs>
      </Box>
